...
const outlets = [
  {
    ...
    settlementSubaccountCode: "LOCAL_ACCT_FARFALLINO",
    latitude: 6.4281,
    longitude: 3.4219,
    deliveryRadiusKm: 12,
    phoneSeed: 31000,
  ...
  },
  {
    ...
    settlementSubaccountCode: "LOCAL_ACCT_SALMAS",
    latitude: 6.4474,
    longitude: 3.4542,
    deliveryRadiusKm: 15,
    phoneSeed: 32000,
...
async function upsertOutlet(seed: (typeof outlets)[number]): Promise<Outlet> {
  ...
  const outlet =
    ...
    outletsRepository.create({ settlementSubaccountCode: seed.settlementSubaccountCode });
