...
export function AuthShell({ children }: { children: ReactNode }) {
  ...
  const isDetailPage = pathname.startsWith("/outlets/") || pathname.startsWith("/menu/");
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[var(--rsc-page-background)] relative">
      ...
      {/* Floating Menu Button for Mobile Screens (hidden on detail pages with back button) */}
      {!isDetailPage && (
        <button
          type="button"
